<?php
  ...
  $Email=$_GET['updateAUID'];
  if(isset($_POST['updateAU'])){
    $Name=$_POST["name"];//get values from form
    $PhoneNumber=$_POST["phone"];
    $Date=$_POST["date"];
    $ProductServiceQuality=$_POST["quality"];
    $CustomerService=$_POST["service"];
    $WebsiteExperience=$_POST["website"];
    $OverallSatisfaction=$_POST["satisfaction"];
    

    $sql="UPDATE customerfeedback SET Name='$Name', Email='$Email',PhoneNumber='$PhoneNumber', Date='$Date', ProductServiceQuality='$ProductServiceQuality',CustomerService='$CustomerService',WebsiteExperience='$WebsiteExperience',OverallSatisfaction='$OverallSatisfaction'
    where Email='$Email'"; //update the data base 
        ...
        <center>
          <body>
            ...
            <form method="post">
              ...
              <input type="submit" value="update" name="updateAU">
            </section> 
        </body>
        </center>
        <footer id="footer">
